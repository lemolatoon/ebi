...
pub type SnappyDecompressIterator<'a> = iter::Map<slice::Iter<'a, f64>, F>;
impl<R: Read> Reader for SnappyReader<R> {
    ...
    fn decompress(&mut self, timer: &mut SegmentedExecutionTimes) -> decoder::Result<&[f64]> {
        ...
        let mut decoder = snap::read::FrameDecoder::new(src_buf.as_slice());
...
impl<R: Read> QueryExecutor for SnappyReader<R> {}
